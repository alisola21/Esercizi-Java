...
public class ContoCorrente {
	...
	//variabile condivisa (modificatore static) -> � la stessa per tutti gli oggetti
	...
	� meglio utilizzare una var statica per non dover calcolare tutte le volte il tasso all'interno dei diversi cc
	*/
	...
	public boolean preleva (double somma) {
		...
		//preleva -> metodo che serve per prelevare soldi dal conto e che restituisce false se il credito no, � sufficiente
			/*public void preleva (double somma) {
				saldo -= somma;
				//traccia i movimenti
				System.out.println("Prelevati " +somma+ " euro");*/
			
		//metodo preleva 2 ->  a differenza del primo, restituisce false se il credito non � sufficiente (ha il return)
